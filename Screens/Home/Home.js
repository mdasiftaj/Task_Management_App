...
const tasks = [
  ...
  { id: 6, taskName: 'Task 6', taskDetails: 'Details of Task 6', taskStatus: 'Pending' },
];
...
const tasksCustom = [
  { id: 1, taskName: 'Task 1', taskDetails: 'Details of Task 1', myStatus: 'Done' },
  ...
  { id: 10, taskName: 'Task 10', taskDetails: 'Details of Task 10', myStatus: 'Done' },
  ,
];
      ...
      <View style={styles.homeView}>
        <View style={styles.profileView}>
          ...
          <View style={styles.details}>
            <Text style={styles.mesText}>Good Morning Asif</Text>
            <Text style={styles.tasksText}>5 Tasks remaining</Text>
          </View>
        </View>
        <TouchableOpacity>
      ...
      <View style={styles.taskSummaryView}>
        <View style={styles.taskSummaryCard}>
          ...
          <View style={styles.addView}>
            <View>
              <Text>Progress <Text style={styles.percentageText}>80%</Text> </Text>
            </View>
